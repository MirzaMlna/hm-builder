<x-app-layout>
        ...
        <div class="mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                @php
                    $cards = [
                        [
                            ...
                            'color' => 'blue',
                            'start' => $presence_schedules->first_check_in_start,
                            'end' => $presence_schedules->first_check_in_end,
                        ],
                        [
                            'label' => 'Presensi Kedua',
                            'color' => 'green',
                            'start' => $presence_schedules->second_check_in_start,
                            'end' => $presence_schedules->second_check_in_end,
                        ],
                        [
                            'label' => 'Presensi Pulang',
                            'color' => 'amber',
                            'start' => $presence_schedules->check_out_start,
                            'end' => $presence_schedules->check_out_end,
                        ],
                    ];
                @endphp
            ...
            <div class="flex flex-col md:flex-row md:space-x-6 space-y-6 md:space-y-0">
                ...
                <div class="bg-white shadow-sm rounded-lg p-6 basis-1/3 flex flex-col">
                    ...
                    <div
                        class="border border-gray-200 rounded-lg w-full aspect-square mx-auto flex items-center justify-center">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            // === Konversi String Waktu ke Date ===
            function parseTime(timeStr) {
                const today = new Date().toISOString().slice(0, 10);
                const [h, m, s = "00"] = timeStr.split(":");
                return new Date(`${today}T${h.padStart(2,"0")}:${m.padStart(2,"0")}:${s.padStart(2,"0")}`);
            }
            ...
            const schedule = @json($presence_schedules);
            ...
            function onScanSuccess(decodedText) {
                ...
                fetch("{{ route('presences.scan') }}", {
                    ...
                    .catch(() => Swal.fire("Error", "Terjadi kesalahan saat presensi", "error"))
                    .finally(() => setTimeout(() => scanned = false, 3000));
            }
